        ...
        <div class="col-12 mt-3 mb-4">
            ...
            <form>
                <div class="form-group">
                    <label for="first_date">Desde:</label>
                    <input class="form-input" type="date" name="first_date" id="first_date">
                </div>
                <div class="form-group">
                    <label for="second_date">Hasta:</label>
                    <input class="form-input" type="date" name="second_date" id="second_date">
                </div>
...
@section('js')
    ...
    <script>
        function search()
        {
            ...
            $.ajax({
                type: "get",
                url: `{{route('search.dates')}}?first_date=${first_date}&second_date=${second_date}`,
                cache: false,
                ...
                success: function (data) {
                    ...
                    let url = `{{route('list.payments')}}?first_date=${first_date}&second_date=${second_date}`
