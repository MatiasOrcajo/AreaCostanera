...
@section('content')
    ...
    <ul class="nav nav-tabs mt-4 mb-3" id="myTab" role="tablist">
        <li class="nav-item" role="presentation">
            <button class="nav-link active" id="egresados_tab-tab" data-bs-toggle="tab" data-bs-target="#egresados_tab" type="button" role="tab" aria-controls="egresados_tab" aria-selected="true">Listado de Egresados</button>
        </li>
        <li class="nav-item" role="presentation">
            <button class="nav-link" id="invitados_tab-tab" data-bs-toggle="tab" data-bs-target="#invitados_tab" type="button" role="tab" aria-controls="invitados_tab" aria-selected="false">Listado de Invitados</button>
        </li>
        <li class="nav-item" role="presentation">
            <button class="nav-link" id="menues_tab-tab" data-bs-toggle="tab" data-bs-target="#menues_tab" type="button" role="tab" aria-controls="menues_tab" aria-selected="false">Menues Especiales</button>
        </li>
    </ul>
